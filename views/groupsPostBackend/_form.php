...
<script type='text/javascript'>
    $(document).ready(function () {
        $('#post-form').liTranslit({
            elName: '#GroupsPost_title',
            elAlias: '#GroupsPost_slug'
        });
    })
</script>
            ...
            $this->widget(
                ...
                [
                    ...
                    'options'        => [
                        ...
                        'placeholder' => Yii::t('GroupsModule.groups', 'tags'),
                    ],
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#group_post_additional">
                        <?php echo Yii::t('GroupsModule.groups', 'Дополнительно'); ?>
                    </a>
                </h4>
            </div>
            <div id="group_post_additional" class="panel-collapse collapse">
                                ...
                                [
                                    'widgetOptions' => [
                                        'data'        => Category::model()->getFormattedList(
                                                (int)Yii::app()->getModule('groups')->mainPostCategory
                                            ),
                                        'htmlOptions' => [
                                            'empty'               => Yii::t('GroupsModule.groups', '--choose--'),
                                            'class'               => 'popover-help',
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#group_post_seodata">
                        <?php echo Yii::t('GroupsModule.groups', 'Data for SEO'); ?>
                    </a>
                </h4>
            </div>
            <div id="group_post_seodata" class="panel-collapse collapse">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-7">
                            <?php echo $form->textFieldGroup(
...
<?php if (!$model->getIsNewRecord() && !$model->isPublished()): ?>
    ...
    $this->widget(
        ...
        [
            ...
            'buttonType'  => 'submit',
            'context'     => 'success',
            'label'       => Yii::t('GroupsModule.groups', 'Publish'),
            'htmlOptions' => [
                'name' => 'post-publish'
            ]
        ]
